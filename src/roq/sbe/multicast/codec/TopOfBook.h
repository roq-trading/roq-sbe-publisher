...
#ifndef _CODEC_TOPOFBOOK_CXX_H_
#define _CODEC_TOPOFBOOK_CXX_H_
...
public:
    static const std::uint16_t SBE_BLOCK_LENGTH = static_cast<std::uint16_t>(137);
    ...
    {
        return *this = TopOfBook(buffer, offset, bufferLength, sbeBlockLength(), sbeSchemaVersion());
    }
    ...
    TopOfBook &wrapForDecode(
        ...
        const std::uint64_t bufferLength)
    {
        return *this = TopOfBook(buffer, offset, bufferLength, actingBlockLength, actingVersion);
    }
...
public:
    ...
    {
        m_layer.wrap(m_buffer, m_offset + 80, m_actingVersion, m_bufferLength);
        return m_layer;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 113, sizeof(std::int64_t));
    ...
    TopOfBook &exchangeTimeUTC(const std::int64_t value) SBE_NOEXCEPT
    {
        ...
        std::memcpy(m_buffer + m_offset + 113, &val, sizeof(std::int64_t));
        return *this;
    }
    ...
    {
        std::int64_t val;
        std::memcpy(&val, m_buffer + m_offset + 121, sizeof(std::int64_t));
        return SBE_LITTLE_ENDIAN_ENCODE_64(val);
    }

    TopOfBook &exchangeSequence(const std::int64_t value) SBE_NOEXCEPT
    {
        std::int64_t val = SBE_LITTLE_ENDIAN_ENCODE_64(value);
        std::memcpy(m_buffer + m_offset + 121, &val, sizeof(std::int64_t));
        return *this;
    }
